              ...
              <tbody>
                @foreach ($roles as $role)
                 <tr>
                    ...
                    <td><button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#slideModal{{$role->id}}">Edit</button>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
              ...
              <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="role_name" name="role_name" value="{{ $role->name }}" placeholder="Enter Name">    
              </div>
